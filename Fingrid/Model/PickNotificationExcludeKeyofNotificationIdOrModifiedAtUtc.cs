...
namespace Fingrid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pick_Notification.Exclude_keyofNotification.id-or-modifiedAtUtc__")]
    public partial class PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc : IEquatable<PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc" /> class.
        /// </summary>
        ...
        public PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc(string messageFi = default(string), string messageEn = default(string), DateTime startTimeUtc = default(DateTime), DateTime endTimeUtc = default(DateTime), string linkFi = default(string), string linkEn = default(string), string linkTextFi = default(string), string linkTextEn = default(string))
        {
            // to ensure "messageFi" is required (not null)
            if (messageFi == null)
            {
                throw new ArgumentNullException("messageFi is a required property for PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc and cannot be null");
            }
            this.MessageFi = messageFi;
            // to ensure "messageEn" is required (not null)
            if (messageEn == null)
            {
                throw new ArgumentNullException("messageEn is a required property for PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc {\n");
        ...
        {
            return this.Equals(input as PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc);
        }

        /// <summary>
        /// Returns true if PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc instances are equal
        /// </summary>
        /// <param name="input">Instance of PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PickNotificationExcludeKeyofNotificationIdOrModifiedAtUtc input)
        {
            if (input == null)
            {
                return false;
