...
namespace Fingrid.Model
{
    ...
    public partial class FileData : IEquatable<FileData>, IValidatableObject
    {
        ...
        public FileData(double id = default(double), DateTime modifiedAtUtc = default(DateTime), DateTime createdAtUtc = default(DateTime), string filenameFi = default(string), string filenameEn = default(string), string messageFi = default(string), string messageEn = default(string), string link = default(string), string fileType = default(string), double size = default(double), DateTime dataFrom = default(DateTime), DateTime dataTo = default(DateTime), double datasetId = default(double))
        {
            this.Id = id;
            // to ensure "filenameFi" is required (not null)
            if (filenameFi == null)
            {
                throw new ArgumentNullException("filenameFi is a required property for FileData and cannot be null");
            }
            this.FilenameFi = filenameFi;
            // to ensure "filenameEn" is required (not null)
            if (filenameEn == null)
            {
                throw new ArgumentNullException("filenameEn is a required property for FileData and cannot be null");
            }
            this.FilenameEn = filenameEn;
            // to ensure "messageFi" is required (not null)
            if (messageFi == null)
            {
                throw new ArgumentNullException("messageFi is a required property for FileData and cannot be null");
            }
            this.MessageFi = messageFi;
            // to ensure "messageEn" is required (not null)
            if (messageEn == null)
            {
                throw new ArgumentNullException("messageEn is a required property for FileData and cannot be null");
            }
            this.MessageEn = messageEn;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for FileData and cannot be null");
            }
            this.Link = link;
            // to ensure "fileType" is required (not null)
            if (fileType == null)
            {
                throw new ArgumentNullException("fileType is a required property for FileData and cannot be null");
            }
