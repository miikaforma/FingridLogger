...
namespace Fingrid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pick_FileDataPrivate.Exclude_keyofFileDataPrivate.id__")]
    public partial class PickFileDataPrivateExcludeKeyofFileDataPrivateId : IEquatable<PickFileDataPrivateExcludeKeyofFileDataPrivateId>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PickFileDataPrivateExcludeKeyofFileDataPrivateId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PickFileDataPrivateExcludeKeyofFileDataPrivateId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PickFileDataPrivateExcludeKeyofFileDataPrivateId" /> class.
        /// </summary>
        ...
        public PickFileDataPrivateExcludeKeyofFileDataPrivateId(DateTime modifiedAtUtc = default(DateTime), string datasetId = default(string), DateTime createdAtUtc = default(DateTime), string filenameFi = default(string), string filenameEn = default(string), string messageFi = default(string), string messageEn = default(string), string link = default(string), string fileType = default(string), double size = default(double), DateTime dataFrom = default(DateTime), DateTime dataTo = default(DateTime))
        {
            // to ensure "datasetId" is required (not null)
            if (datasetId == null)
            {
                throw new ArgumentNullException("datasetId is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
            this.DatasetId = datasetId;
            // to ensure "filenameFi" is required (not null)
            if (filenameFi == null)
            {
                throw new ArgumentNullException("filenameFi is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
            this.FilenameFi = filenameFi;
            // to ensure "filenameEn" is required (not null)
            if (filenameEn == null)
            {
                throw new ArgumentNullException("filenameEn is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
            this.FilenameEn = filenameEn;
            // to ensure "messageFi" is required (not null)
            if (messageFi == null)
            {
                throw new ArgumentNullException("messageFi is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
            this.MessageFi = messageFi;
            // to ensure "messageEn" is required (not null)
            if (messageEn == null)
            {
                throw new ArgumentNullException("messageEn is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
            this.MessageEn = messageEn;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
            this.Link = link;
            // to ensure "fileType" is required (not null)
            if (fileType == null)
            {
                throw new ArgumentNullException("fileType is a required property for PickFileDataPrivateExcludeKeyofFileDataPrivateId and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PickFileDataPrivateExcludeKeyofFileDataPrivateId {\n");
        ...
        {
            return this.Equals(input as PickFileDataPrivateExcludeKeyofFileDataPrivateId);
        }

        /// <summary>
        /// Returns true if PickFileDataPrivateExcludeKeyofFileDataPrivateId instances are equal
        /// </summary>
        /// <param name="input">Instance of PickFileDataPrivateExcludeKeyofFileDataPrivateId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PickFileDataPrivateExcludeKeyofFileDataPrivateId input)
        {
            if (input == null)
            {
                return false;
