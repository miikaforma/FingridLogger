...
namespace Fingrid.Model
{
    ...
    /// DatasetSearchResult
    /// </summary>
    [DataContract(Name = "DatasetSearchResult")]
    public partial class DatasetSearchResult : IEquatable<DatasetSearchResult>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DatasetSearchResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DatasetSearchResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DatasetSearchResult" /> class.
        /// </summary>
        ...
        public DatasetSearchResult(double id = default(double), DateTime modifiedAtUtc = default(DateTime), DatasetType type = default(DatasetType), string organization = default(string), string nameFi = default(string), string nameEn = default(string), string descriptionFi = default(string), string descriptionEn = default(string), List<string> contentGroupsFi = default(List<string>), List<string> contentGroupsEn = default(List<string>), List<string> keyWordsFi = default(List<string>), List<string> keyWordsEn = default(List<string>), List<DatasetFormat> availableFormats = default(List<DatasetFormat>), string dataPeriodFi = default(string), string dataPeriodEn = default(string), string unitFi = default(string), string unitEn = default(string), double searchScore = default(double))
        {
            ...
            {
                throw new ArgumentNullException("organization is a required property for DatasetSearchResult and cannot be null");
            }
            this.Organization = organization;
            // to ensure "nameFi" is required (not null)
            if (nameFi == null)
            {
                throw new ArgumentNullException("nameFi is a required property for DatasetSearchResult and cannot be null");
            }
            this.NameFi = nameFi;
            // to ensure "nameEn" is required (not null)
            if (nameEn == null)
            {
                throw new ArgumentNullException("nameEn is a required property for DatasetSearchResult and cannot be null");
            }
            this.NameEn = nameEn;
            // to ensure "descriptionFi" is required (not null)
            if (descriptionFi == null)
            {
                throw new ArgumentNullException("descriptionFi is a required property for DatasetSearchResult and cannot be null");
            }
            this.DescriptionFi = descriptionFi;
            // to ensure "descriptionEn" is required (not null)
            if (descriptionEn == null)
            {
                throw new ArgumentNullException("descriptionEn is a required property for DatasetSearchResult and cannot be null");
            }
            this.DescriptionEn = descriptionEn;
            // to ensure "dataPeriodFi" is required (not null)
            if (dataPeriodFi == null)
            {
                throw new ArgumentNullException("dataPeriodFi is a required property for DatasetSearchResult and cannot be null");
            }
            this.DataPeriodFi = dataPeriodFi;
            // to ensure "dataPeriodEn" is required (not null)
            if (dataPeriodEn == null)
            {
                throw new ArgumentNullException("dataPeriodEn is a required property for DatasetSearchResult and cannot be null");
            }
            this.DataPeriodEn = dataPeriodEn;
            // to ensure "unitFi" is required (not null)
            if (unitFi == null)
            {
                throw new ArgumentNullException("unitFi is a required property for DatasetSearchResult and cannot be null");
            }
            this.UnitFi = unitFi;
            // to ensure "unitEn" is required (not null)
            if (unitEn == null)
            {
                throw new ArgumentNullException("unitEn is a required property for DatasetSearchResult and cannot be null");
            }
            this.UnitEn = unitEn;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DatasetSearchResult {\n");
        ...
        {
            return this.Equals(input as DatasetSearchResult);
        }

        /// <summary>
        /// Returns true if DatasetSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DatasetSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatasetSearchResult input)
        {
            if (input == null)
            {
                return false;
